                ...
                <div class="card pub_image pub_image_detail">
                    ...
                    <div class="card-body">
                        ...
                        <div class="likes">
                            ...
                            {{-- Comprobar si el user le dió like a la imagen --}}
                            <?php $user_like = false ?>
                            ...
                            @endforeach
                            @if($user_like)
                                <img src="{{asset('img/heart-red.png')}}" data-id="{{$image->id}}" alt="" class="btn-dislike">
                            @else
                                <img src="{{asset('img/heart-black.png')}}" data-id="{{$image->id}}" alt="" class="btn-like">
                            @endif
                            ...
                            <a href="{{route('image.edit',['id' => $image->id])}}"class="btn btn-sm btn-primary">Actualizar </a>
                                ...
                                <div class="modal-dialog">
                                    ...
                                    <div class="modal-body">
                                        <p>Si eliminas esta imagen nunca podrás recuperarla, ¿seguro que quieres borrarla?</p>
                                    </div>
                            ...
                            @foreach($image->comments as $comment)
                                ...
                                <div class="comment">
                                    <div class="description">
                                        ...
                                        @if(Auth::check() && ($comment->user_id == Auth::user()->id || $comment->image_id == Auth::user()->id))
